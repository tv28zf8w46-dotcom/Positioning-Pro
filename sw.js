...
const CACHE = "positioning-pro-v5";
const ASSETS = ["./", "./index.html", "./manifest.webmanifest", "./feedback-fx.js", "./review-scheduler.js", "./streak-combo.js", "./ghost-replay.js", "./requisition.js", "./radiograph-sim.js", "./icon-192.png", "./icon-512.png", "./icon-512-maskable.png"];
